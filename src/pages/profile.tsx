...
const Profile = () => {
    ...
    function Banner() {
        return (
            <div className="fixed w-5/6 mt-2 z-50 place-content-center">
                <Box sx={{
                    ...
                    <div className="flex content-center ml-2 gap-4">
                        ...
                        <Typography variant="body1" gutterBottom>You haven't filled out your annual survey yet.
                        </Typography>
                    </div>
    ...
    return (
        <div className="flex flex-col w-full h-full md:px-16 py-8 gap-2">
